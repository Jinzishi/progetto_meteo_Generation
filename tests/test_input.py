...
class TestInputValidation:
    ...
    @patch("geocoding._session.get")
    def test_empty_string_raises_error(self, mock_get):
        """Stringa vuota: l'API non trova risultati."""
        mock_get.return_value.raise_for_status = lambda: None
        mock_get.return_value.json.return_value = {}
    ...
    @patch("geocoding._session.get")
    def test_only_spaces_raises_error(self, mock_get):
        """Solo spazi: dopo strip l'API non trova risultati."""
        mock_get.return_value.raise_for_status = lambda: None
        mock_get.return_value.json.return_value = {}
    ...
    @patch("geocoding._session.get")
    def test_numeric_input_raises_error(self, mock_get):
        """Input numerico: l'API non trova risultati."""
        mock_get.return_value.raise_for_status = lambda: None
        mock_get.return_value.json.return_value = {}
